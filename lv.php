...
<body>
    ...
    <header class="header">
        ...
        <nav class="navbar">
            ...
            <a href="#home" class="active">Galvena</a>
            <a href="#about" class="nav">Par mani</a>
            <a href="#services" class="nav">Serviss</a>
            <a href="#portfolio" class="nav">Pēdējie Darbi</a>
            <a href="#contact" class="nav">Kontakti</a>
        </nav>
    </header>
